...
import 'package:my_tiktok/tik_tok_icons_icons.dart';
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          _getFollowAction(),
          _getSocialAction(icon: TikTokIcons.heart, title: '3.2m',isShare: false,),
          _getSocialAction(icon: TikTokIcons.chat_bubble, title: '16.4k',isShare:false,),
